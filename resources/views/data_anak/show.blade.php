            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                            ...
                            <input type="text" name="nm_anak" value="{{$data_anak->nama_anak}}" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tgl_lahir" value="{{date('d-m-Y', strtotime($data_anak->tanggal_lahir )) }}" class="form-control" readonly>
                        </div>
                        <div class="form-group">
